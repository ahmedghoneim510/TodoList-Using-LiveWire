                ...
                <form>
                    <div class="mb-6">
                        <label for="title"
                            ...
                            Todo </label>
                        <input type="text" wire:model="title" id="title" placeholder="Todo.."
                               class="bg-gray-100  text-gray-900 text-sm rounded block w-full p-2.5">
                        @error('title') <span class="text-red-500 text-xs mt-3 block ">{{ $message }}</span> @enderror
{{--                        <span class="text-red-500 text-xs mt-3 block ">Error</span>--}}
                    ...
                    @if(session()->has('message'))
                        <span class="text-green-500 text-xs mt-3 ">{{ session('message') }}</span>
                    @endif
